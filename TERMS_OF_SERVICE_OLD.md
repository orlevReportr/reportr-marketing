...
Reportr provides an AI-powered platform that transforms client meetings and conversations into professional, regulation-ready reports for financial advisors and other regulated services professionals. Our Service includes:
...
- Integration with third-party services (Zoom, Google Calendar, etc.)
...
- **Starter Plan:** Usage-based pricing with enhanced features
...
### 6.1 Permitted Uses
You may use the Service only for lawful purposes and in accordance with these Terms. You agree to use the Service in a professional manner consistent with its intended purpose of creating compliant business documentation.
...
**Service Misuse:**
- Use the Service to create false, misleading, or fraudulent documentation
...
- Upload personally identifiable information of third parties without consent
...
- You must review all AI-generated content for accuracy, completeness, and compliance
- We do not provide legal, financial, or professional advice through the Service
- The Service does not guarantee compliance with any specific regulations or standards
...
- You must independently verify all information before relying on or distributing it
...
- Templates and content we provide
...
- Google (Google Calendar, Google Drive, Google SSO)
- Microsoft (Microsoft 365, Microsoft SSO)
- Zoom (meeting recordings)
- Other calendar and communication platforms
...
We are committed to compliance with applicable data protection laws and are working toward SOC 2 certification.
...
- We do not provide professional advice (legal, financial, or otherwise)
- You are solely responsible for compliance with professional regulations
...
- Your User Content will be retained for 90 days for retrieval, then deleted
...
Before filing a claim, you agree to contact us to attempt informal resolution. We will work in good faith to resolve disputes amicably.
